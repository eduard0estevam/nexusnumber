...
// teste que vai fazer o calculo escolhido
        if(operacao == 1){
			...
			//A variável "vidas" só precisava ser trazida como ponteiro pra o valor original na função
			//main poder ser alterado. Só "vidas" tava alterando a cópia local e o int vidas continuava com o valor 3.
      //troquei o "!=" por ">" pra ficar um pouco mais limpo.
            while(*vidas > 0){
